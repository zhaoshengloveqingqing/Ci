...
function cal_col_pos(row, col, items, layout_data, mb) {
	...
	//console.info("row = " + row + " col = " + col + " total = " + total);
	return total;
}
...
function layout(items, cols, mb, mr) {
	...
	// console.table(layout_data);
	// console.table(flow_layout_data);
	// for(var i = 0; i < flow_layout_data.length - 1; i++) {
	// 	console.info(get_flow_row_height(i, flow_layout_data, items, mb));
	// }
