...
(function ($) {
    $.replaceAll = function(v, s1, s2) {
        console.log(v);
        return v.replace(new RegExp(s1, "gm"), s2); //g全局
    }
    //date & time aliases
