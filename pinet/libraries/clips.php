...
class Clips {
	...
	public function __construct($name = CLIPS_MAIN_ENV) {
		...
		else // If the env is already exists
	...
	public function defClass($class, $parents, $abstract = false, $slots = null, $methods = null) {
		$this->command($this->defineClass($class, $parents, $abstract, $slots, $methods));
	}
